...
namespace Zadanie3
{
    public partial class Genre
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath("Genre.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Genre");
            if (labelColumn == null)
            {
                throw new Exception("Genre column not found. Make sure the name searched for matches the name in the schema.");
            }
