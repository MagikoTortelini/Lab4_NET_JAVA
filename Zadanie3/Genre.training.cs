...
namespace Zadanie3
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Magik\Downloads\archive (3)\Genre Classification Dataset\movies_ml.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Description",outputColumnName:@"Description")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=1F,L2Regularization=1F,LabelColumnName=@"Genre",FeatureColumnName=@"Features"}))      
